...
export const PopoverDemo = ({ children }: { children: React.ReactNode }) => {
    ...
    const [popoverData, updateLayer] = React.useState({
        isOpen: false,
        avoidAnchor: false,
        positionX: `center` as keyof typeof overlayPosition,
        positionY: `after` as keyof typeof overlayPosition,
        matchWidth: false,
        matchHeight: false,
        backdrop: `none` as PopoverProps['backdrop'],
    });
            ...
            <form onSubmit={formSubmit}>
                ...
                <select
                    ...
                    onChange={({ target }) =>
                        updateLayer((data) => ({
                            ...data,
                            positionX: target.value as keyof typeof overlayPosition,
                        }))
                    }
                >
                ...
                <select
                    ...
                    onChange={({ target }) =>
                        updateLayer((data) => ({
                            ...data,
                            positionY: target.value as keyof typeof overlayPosition,
                        }))
                    }
                >
                    <option value="before" label="before" />
                ...
                <select
                    ...
                    onChange={({ target }) =>
                        updateLayer((data) => ({
                            ...data,
                            backdrop: target.value as PopoverProps['backdrop'],
                        }))
                    }
                >
